...
se desarrolló un algoritmo de Búsqueda Primero en Profundidad (DFS, por sus siglas en inglés) para encontrar un camino válido desde un punto de inicio hasta
...
La estrategia implementada para solucionar el problema es la \textbf{Búsqueda Primero en Profundidad} (\textit{Depth-First Search}). Este algoritmo no informado expande siempre el nodo más profundo en la frontera de búsqueda actual. La metodología se desglosa en los siguientes componentes:
